...
-- EXEC [dbo].[dbasp_start_job] @JobName = 'xSWL-Test', @WaitIfRunning_TOD = '10:40:00', @DelayMinAfterKill = 2, @ErrorIfRunning = 0, @KillAfterWait = 1

GO
SET NOCOUNT ON
GO
IF OBJECT_ID('dbasp_start_job') IS NOT NULL
	DROP PROCEDURE dbo.dbasp_start_job
GO
