...
FROM		dbaadmin.dbo.dbaudf_DirectoryList2('C:\WINDOWS\assembly\',null,1) T1 -- ACTUALLY LOOK IN THE GAC
...
--exec sp_MSForEachDB 'USE [?];if exists (select * From sys.assemblies WHERE name != ''Microsoft.SqlServer.Types'' AND permission_set_desc = ''UNSAFE_ACCESS'') ALTER DATABASE [?] SET TRUSTWORTHY ON;'
