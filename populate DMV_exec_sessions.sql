...
SELECT		CASE
			...
			WHEN LEFT([host_name],11) = 'SEAPCRM5IWS'	THEN 'CRM IWS'
			WHEN LEFT([host_name],11) = 'SEAPCRM5WEB'	THEN 'CRM WEB'
		...
		,REVERSE(PARSENAME(REVERSE([host_name]),1))
		,REVERSE(PARSENAME(REVERSE([host_name]),2))
		--,program_name
		--,[login_name]
