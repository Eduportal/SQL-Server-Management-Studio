...
SELECT		@Path_Backup	= '\\SQLDEPLOYER02\SQLDEPLOYER02_restore\TXC'
			,@File_Backup	= 'Transcoder_db_20110819210135.SQB'
			,@DBName		= 'Transcoder'
			,@Delay			= 5
			,@DelayTemp		= 0	
...
EXEC	dbaadmin.dbo.dbasp_FileAccess_Write @CMD,'\\sqldeployer05\SQLDEPLOYER05_SQLjob_logs','ProductCatalog_restore.log',1
