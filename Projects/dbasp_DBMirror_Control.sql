...
IF OBJECT_ID('dbasp_DBMirror_Control') IS NOT NULL
	DROP PROCEDURE [dbo].[dbasp_DBMirror_Control]
GO
...
AS
	...
	IF @Function = 'help'
	BEGIN
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '---------- EXAMPLE SCRIPTS -----------',1,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '--PAUSING MIRRORING ON ALL MIRRORED DATABASES--',1,0,1
		exec dbaadmin.dbo.dbasp_print 'EXEC [dbaadmin].[dbo].[dbasp_DBMirror_Control]',2,0,1
		exec dbaadmin.dbo.dbasp_print '@Function = ''SUSPEND''',4,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '--PAUSING MIRRORING ON A SINGLE MIRRORED DATABASE--',1,0,1
		exec dbaadmin.dbo.dbasp_print 'EXEC [dbaadmin].[dbo].[dbasp_DBMirror_Control]',2,0,1
		exec dbaadmin.dbo.dbasp_print '@Function = ''SUSPEND''',4,0,1
		exec dbaadmin.dbo.dbasp_print ',@DBName = ''MirroredDatabaseName''',4,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '--RESUME MIRRORING ON ALL MIRRORED DATABASES--',1,0,1
		exec dbaadmin.dbo.dbasp_print 'EXEC [dbaadmin].[dbo].[dbasp_DBMirror_Control]',2,0,1
		exec dbaadmin.dbo.dbasp_print '@Function = ''RESUME''',4,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '--REMOVE MIRRORING ON A SINGLE MIRRORED DATABASE--',1,0,1
		exec dbaadmin.dbo.dbasp_print 'EXEC [dbaadmin].[dbo].[dbasp_DBMirror_Control]',2,0,1
		exec dbaadmin.dbo.dbasp_print '@Function = ''OFF''',4,0,1
		exec dbaadmin.dbo.dbasp_print ',@DBName = ''MirroredDatabaseName''',4,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '--FAILOVER MIRRORING ON A SINGLE MIRRORED DATABASE--',1,0,1
		exec dbaadmin.dbo.dbasp_print 'EXEC [dbaadmin].[dbo].[dbasp_DBMirror_Control]',2,0,1
		exec dbaadmin.dbo.dbasp_print '@Function = ''FAILOVER''',4,0,1
		exec dbaadmin.dbo.dbasp_print ',@DBName = ''MirroredDatabaseName''',4,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '--START MIRRORING A SINGLE DATABASE--',1,0,1
		exec dbaadmin.dbo.dbasp_print 'EXEC [dbaadmin].[dbo].[dbasp_DBMirror_Control]',2,0,1
		exec dbaadmin.dbo.dbasp_print '@Function = ''START''',4,0,1
		exec dbaadmin.dbo.dbasp_print ',@DBName = ''PrimaryDatabaseName''',4,0,1
		exec dbaadmin.dbo.dbasp_print ',@ServerName = ''PrimaryServerName''',4,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1
		exec dbaadmin.dbo.dbasp_print '--SHOW MIRRORING STATUS ON ALL MIRRORED DATABASES--',1,0,1
		exec dbaadmin.dbo.dbasp_print 'EXEC [dbaadmin].[dbo].[dbasp_DBMirror_Control]',2,0,1
		exec dbaadmin.dbo.dbasp_print '@Function = ''STATUS''',4,0,1
		exec dbaadmin.dbo.dbasp_print '',1,0,1		
	...
	IF NOT EXISTS(select 1 from dbaadmin.dbo.Local_ServerEnviro where env_type = 'mirror_failover_override' and datediff(mi, convert(datetime,env_detail), getdate()) < 45)
	BEGIN
		SELECT @CMD = 'DBA Error:  Override required.  Use: insert into dbaadmin.dbo.Local_ServerEnviro values(''mirror_failover_override'', getdate())'
	...
	BEGIN
		...
		EXEC [dbaadmin].[dbo].[dbasp_Mirror_Database] @ServerName,@DBName,DEFAULT,DEFAULT,1,0
