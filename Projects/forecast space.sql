...
GO
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[db_stats_log]') AND name = N'IX_db_stats_log_c_6_309576141__K2_K1')
CREATE CLUSTERED INDEX [IX_db_stats_log_c_6_309576141__K2_K1] ON [dbo].[db_stats_log]
(
	[DatabaseName] ASC,
	[ServerName] ASC
...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[db_stats_log]') AND name = N'IX_db_stats_log_6_309576141__K2_K1_3')
CREATE NONCLUSTERED INDEX [IX_db_stats_log_6_309576141__K2_K1_3] ON [dbo].[db_stats_log]
(
	[DatabaseName] ASC,
	[ServerName] ASC
)
INCLUDE ( 	[rundate]) WITH (SORT_IN_TEMPDB = OFF, DROP_EXISTING = OFF, ONLINE = OFF) ON [PRIMARY]
GO
