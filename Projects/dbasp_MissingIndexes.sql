...
IF OBJECT_ID('dbo.dbasp_MissingIndexes', 'P') IS NOT NULL DROP PROCEDURE dbo.dbasp_MissingIndexes
GO

/**
*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=
dbasp_MissingIndexes
...
Usage:
	EXECUTE dbasp_MissingIndexes 'dbo', 'visit%', 1

*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=*=
**/

CREATE PROCEDURE dbo.dbasp_MissingIndexes
	@SchemeName sysname='',
	@TableName sysname='',
	@Sort Tinyint=1,
	@Delimiter VarChar(1)=','
