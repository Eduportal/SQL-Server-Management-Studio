...
DECLARE	@DBName		NVARCHAR(255)
	...
	,@Port		NVARCHAR(255)
	,@SQLLink	NVARCHAR(255)
	,@ShareLink	NVARCHAR(255)
...
FETCH NEXT FROM NewItemCursor INTO @DBName,@ENVName,@SQLName,@Port,@SQLLink,@ShareLink	
...
BEGIN
	...
	BEGIN
		...
		SET @Size = LEN(@DBName+@ENVName+@SQLName+@Port+@SQLLink+@ShareLink+@ShareLink)
