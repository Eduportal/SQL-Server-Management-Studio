...
/****** Object:  UserDefinedFunction [dbo].[dbaudf_GetJobStatus]    Script Date: 12/19/2012 10:29:15 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[dbaudf_GetJobStatus]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
DROP FUNCTION [dbo].[dbaudf_GetJobStatus]
GO
