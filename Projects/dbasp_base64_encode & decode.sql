IF object_id('[dbo].[dbasp_base64_decode]') IS NOT NULL
  DROP FUNCTION [dbo].[dbasp_base64_decode]
GO

CREATE FUNCTION dbasp_base64_decode
(
...
IF object_id('[dbo].[dbasp_base64_encode]') IS NOT NULL
  DROP FUNCTION [dbo].[dbasp_base64_encode]
GO

CREATE FUNCTION dbasp_base64_encode
(
