...
BEGIN
	...
	BEGIN
		...
		SET			@DeclareText = ''
		SELECT		@DeclareText = @DeclareText + 'DECLARE '+ SplitValue + ' Sql_Variant' + CHAR(13)+CHAR(10)
		FROM		(
					SELECT		DISTINCT
								SplitValue 
					FROM		[DBAadmin].[dbo].dbaudf_split (REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(@StatementText,CHAR(13)+CHAR(10),' '),'+',' '),'-',' '),'*',' '),'/',' '),'=',' '),'  ',' '),'  ',' '),' ')
		...
		SET @StatementText	= REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(@StatementText,CHAR(9),' '),'  ',' '),'  ',' '),'  ',' '),CHAR(13)+CHAR(10)+' ',CHAR(13)+CHAR(10)),CHAR(13)+CHAR(10)+CHAR(13)+CHAR(10),CHAR(13)+CHAR(10)),CHAR(13)+CHAR(10)+' ',CHAR(13)+CHAR(10)),CHAR(13)+CHAR(10)+CHAR(13)+CHAR(10),CHAR(13)+CHAR(10)),CHAR(13)+' ',CHAR(13)),CHAR(10)+' ',CHAR(10))
		PRINT @StatementText
		PRINT ''
