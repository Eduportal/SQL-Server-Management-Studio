...
BEGIN -- RUN REPORTS
	...
	WHERE		(database_id = @database_id OR @database_id IS NULL OR @PopulateDMVsForAll = 1)
	    AND		(object_id = @object_id OR @object_id IS NULL OR @PopulateDMVsForAll = 1)
	...
	WHERE		(T1.database_id = @database_id OR @database_id IS NULL OR @PopulateDMVsForAll = 1)
	    AND		(T1.object_id = @object_id OR @object_id IS NULL OR @PopulateDMVsForAll = 1)
