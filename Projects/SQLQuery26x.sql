...
GO
IF OBJECT_ID('dbasp_Worst_TSQL') IS NOT NULL
	DROP PROC [dbo].[dbasp_Worst_TSQL]
GO	
CREATE PROC [dbo].[dbasp_Worst_TSQL]
/*
...
SET		@DBName = DB_NAME()
EXEC dbasp_Worst_TSQL @DBNAME = @DBName,@COUNT=100,@ORDERBY='TE'; 