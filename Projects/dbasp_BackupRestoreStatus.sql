USE DBAADMIN
GO
IF OBJECT_ID('dbo.dbasp_BackupRestoreStatus') IS NOT NULL
	DROP PROCEDURE	dbo.dbasp_BackupRestoreStatus
GO
...
exec	dbaadmin.dbo.dbasp_BackupRestoreStatus		-- same as 0
exec	dbaadmin.dbo.dbasp_BackupRestoreStatus 0	-- Return as Text Message
exec	dbaadmin.dbo.dbasp_BackupRestoreStatus 1	-- Return as Table Data
GO