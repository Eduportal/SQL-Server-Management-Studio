...
------------------------------------------------------------------------------------------------------- 
-- IndexMaintenancePhysicalStats
------------------------------------------------------------------------------------------------------- 
if exists (select * from sys.objects where object_id = object_id(N'[dbo].[IndexMaintenancePhysicalStats]') and OBJECTPROPERTY(object_id, N'IsTable') = 1)
drop table [dbo].[IndexMaintenancePhysicalStats]
GO
SET ANSI_NULLS ON
GO
...
------------------------------------------------------------------------------------------------------- 
if exists (select * from sys.objects where object_id = object_id(N'[dbo].[IndexMaintenanceLastRunDetails]') and OBJECTPROPERTY(object_id, N'IsTable') = 1)
drop table [dbo].[IndexMaintenanceLastRunDetails]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
-- dbasp_LogMsg
------------------------------------------------------------------------------------------------------- 
if exists (select * from sys.objects where object_id = object_id(N'[dbo].[dbasp_LogMsg]') and OBJECTPROPERTY(object_id, N'IsProcedure') = 1)
drop procedure [dbo].[dbasp_LogMsg]
GO
...
------------------------------------------------------------------------------------------------------- 
-- dbasp_FileAccess_Write
------------------------------------------------------------------------------------------------------- 
if exists (select * from sys.objects where object_id = object_id(N'[dbo].[dbasp_FileAccess_Write]') and OBJECTPROPERTY(object_id, N'IsProcedure') = 1)
...
------------------------------------------------------------------------------------------------------- 
-- dbasp_IndexMaintenance
------------------------------------------------------------------------------------------------------- 
if exists (select * from sys.objects where object_id = object_id(N'[dbo].[dbasp_IndexMaintenance]') and OBJECTPROPERTY(object_id, N'IsProcedure') = 1)
drop procedure [dbo].[dbasp_IndexMaintenance]
GO
...
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbasp_IndexMaintenance]
...
END'+CHAR(13)+CHAR(10)+CHAR(13)+CHAR(10)
	...
	if @usesOnlineReindex = 1 AND CAST(SERVERPROPERTY('Edition') AS VarChar(255)) NOT like '%Enterprise%' AND CAST(SERVERPROPERTY('Edition') AS VarChar(255)) NOT like '%Developer%'
		BEGIN
			--------------------------------------------
