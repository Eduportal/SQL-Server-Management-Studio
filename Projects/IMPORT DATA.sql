...
SET @Path = '\\seafresqldba01\SEAFRESQLDBA01_dbasql\dba_UpdateFiles'
...
BEGIN
	...
	BEGIN
		...
		select @DateLastModified = dbaadmin.dbo.dbaudf_GetFileProperty(@Path+'\'+@FileName,'DateLastModified')
